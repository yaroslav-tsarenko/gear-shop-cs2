...
import "./TermsAndConditionsSecondPage.css";

const TermsAndConditionsSecondPage = () => {
  return (
    <div className="termsandconditionssecondpage">
      <HeaderDesktop />
      <section className="terms-conditions-parent">
...
export default TermsAndConditionsSecondPage;
